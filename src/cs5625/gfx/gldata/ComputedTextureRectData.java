...
public class ComputedTextureRectData implements TextureRectData {
    ...
    public ComputedTextureRectData() {
    }

    public ComputedTextureRectData(int internalFormat) {
        this.internalFormat = internalFormat;
    }

    public ComputedTextureRectData setInternalFormat(int internalFormat) {
        this.internalFormat = internalFormat;
        return this;
    }
    ...
    public void updateGLResource(GL2 gl, GLResourceRecord record) {
        if (width == 0 || height == 0 || glFormat == Integer.MIN_VALUE || glType == Integer.MAX_VALUE) {
            ...
            if (record.resource == null) {
                texture = new TextureRect(gl, internalFormat);
