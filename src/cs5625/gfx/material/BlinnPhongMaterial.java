...
public class BlinnPhongMaterial extends AbstractMaterial {
    ...
    public BlinnPhongMaterial(Color4f diffuse) {
    ...
    public BlinnPhongMaterial setDiffuseColor(Color4f diffuse) {
        diffuseColor.set(diffuse);
        return this;
    }
    ...
    public BlinnPhongMaterial setSpecularColor(Color3f specular) {
    ...
    public BlinnPhongMaterial setExponent(float exponent) {
    ...
    public BlinnPhongMaterial setDiffuseTexture(Holder<Texture2DData> texture) {
    ...
    public BlinnPhongMaterial setSpecularTexture(Holder<Texture2DData> texture) {
    ...
    public BlinnPhongMaterial setExponentTexture(Holder<Texture2DData> texture) {
